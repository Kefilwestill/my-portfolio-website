...
export class AboutComponent {
  ...
  bio = [
    ...
    'Currently advancing my skills through an intensive Angular and SpringBoot Bootcamp, I am committed to building modern web solutions that make a difference.',
  ...
  highlights = [
    ...
    { icon: 'fas fa-rocket', label:'Fast Learner', description: 'Quick to adapt to new technologies' },
